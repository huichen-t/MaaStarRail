...
# This file was automatically generated by module/config_src/config_updater.py.
# Don't modify it manually.


class GeneratedConfig:
    """
    自动生成的配置类，用于管理游戏自动化过程中的各种配置参数。
    此文件由module/config_src/config_updater.py自动生成，请勿手动修改。
    会被Config_updater中重新覆盖 改了也没用
    ...
    2. 模拟器配置 (Emulator)
       - 序列号、游戏客户端、包名、语言、截图方法等
       - 控制方法、云服务优先级等

    3. 模拟器信息 (EmulatorInfo)
       - 模拟器类型、名称、路径等
    ...
    17. 规划器扫描 (PlannerScan)
        - 结果添加设置

    注意：所有配置项都有默认值，可以根据需要进行修改。
    修改配置时请参考注释中的可选值范围。
    """
    ...
    # Group `Emulator`
    Emulator_Serial = '127.0.0.1:16416'
